...
def run(model, label_dict, n_class, params):
    ...
    if model.graph_name not in ['mkarate', 'barbell']:
    ...
    df.to_csv("../tsne_vectors/rolx_{}.csv".format(model.graph_name))

    figure_path = "../tsne_figures/rolx_{}.png".format(model.graph_name)
